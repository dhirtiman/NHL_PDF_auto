...
async function mergePdfWithSingleRow(slNumberToFind, callback) {
  ...
  fs.createReadStream(`data/${step1CSV}`)
    ...
    .on('end', async () => {
      ...
      page.drawText(`${rowData['Sl Number']}/${preFix}`, {
        x: 1200,
        y: 2340,
        font,
        size: textSize,
      ...
      page.drawText(`${rowData['Phone number']}`, {
        x: 900,
        y: 1150,
        font,
        size: textSize,
...
async function generatePdfFromSlNumber(slNumberToFind, callback) {
  ...
  fs.createReadStream(`data/${step2CSV}`)
    ...
    .on('end', async () => {
      ...
      page1.drawText(`${rowData.BodyFat}`, {
        x: 1100,
        y: 700 - yMinus,
        font,
        size: textSize,
      ...
      page1.drawText(`${rowData['LeanMass(S/M)']}`, {
        x: 1700,
        y: 700 - yMinus,
        font,
        size: textSize,
      ...
      page1.drawText(`${rowData.VisceralFat}`, {
        x: 2350,
        y: 700 - yMinus,
        font,
        size: textSize,
      ...
      page1.drawText(`${rowData.WaistLine}`, {
        x: 2900,
        y: 700 - yMinus,
        font,
        size: textSize,
      ...
      page1.drawText(`${rowData.WaistHipRatio}`, {
        x: 3650,
        y: 700 - yMinus,
        font,
        size: textSize,
      ...
      page1.drawText(`${rowData.BodyAge}`, {
        x: 4300,
        y: 700 - yMinus,
        font,
        size: textSize,
      ...
      page1.drawText(`${rowData['Dietary preference']}`, {
        x: 3451,
        y: 1300 - yMinus,
        font,
        size: textSize,
      ...
      const medicalConditions =
        rowData['select any medical conditions'].split(',');
      ...
      const healthConcerns =
        rowData['Select any other Health concerns'].split(',');
      ...
      page4.drawText(`${coreSupplementsText}`, {
        x: 600,
        y: 1900,
        font,
        size: textSize + 10,
      ...
      console.log(
        `PDF for SL_Number ${slNumberToFind} generated successfully!`
      );
...
async function step3(slNumberToFind, callback) {
  ...
  fs.createReadStream(`data/${step3CSV}`)
    ...
    .on('end', async () => {
      ...
      tickWidth = tickImage.width * 0.5;
      tickheight = tickImage.height * 0.5;

      //page2 stuff Question answer

      const q1 =
        rowData[
          'Q1 How often do you eat meals in a day (including tea, coffee, fruits, salads, snacks)?'
        ];
      const q1ZCoor = 300;
      ...
      const q2 =
        rowData[
          'Q2 How often do you drink sweetened beverages like soft drinks, juices, etc.?'
        ];
      const q2ZCoor = 2250;
      ...
      const q3 =
        rowData[
          'Q3. How often do you eat fried foods such as Puri, Parathas, Fried chicken, momo, chow, Noodles, etc .'
        ];
      const q3ZCoor = 2050;
      ...
      const q4 =
        rowData[
          'Q4. How often do you eat sweets such as Laddu, Barfi, Jalebi, Kulfi, Chocolate, Halwa, Rice pudding, etc.?'
        ];
      const q4ZCoor = 1880;
      ...
      const q4Map = {
        ...
        '2 to 3 times in a month': [2550, q4ZCoor],
      ...
      const q5 =
        rowData[
          'Q5.How often do you eat high salt snacks such as Namkeen, Bhujia, Meat/Veg Pickles, Chutney, Papad etc.?'
        ];
      const q5ZCoor = 1700;
      ...
      const q6 =
        rowData[
          'Q6 How often do you consume sugar and honey in tea, coffee, curd, lassi, etc?'
        ];
      const q6ZCoor = 1540;
      ...
      const q9 =
        rowData[
          'Q9 .How often do you eat saturated fat like Pork, mutton, Beef fat, egg yolks, etc.?'
        ];
      const q9ZCoor = 1390;
      ...
      const q10 =
        rowData[
          'Q10 How often do you eat refined food items like burgers, pizza, KFC etc.?'
        ];
      const q10ZCoor = 1210;
      ...
      const q12 =
        rowData[
          'Q12 How often do you eat out of the house (such as in Resturant , party, family function, wedding etc )?'
        ];
      const q12ZCoor = 300;
      ...
      //Question 14
      const q14 =
        rowData['Q14 How much time do you exercise for each session?'];
      const q14ZCoor = 1500;
      ...
      const q15 =
        rowData[
          "How many times a week do you drink alcohol ?( choose 0 if you don't)"
        ];
      const q15ZCoor = 1050;
      ...
      const q16 =
        rowData["How many times a week do you smoke?( choose 0 if you don't)"];
      const q16ZCor = 730;

      const q16Map = {
        "Never": [3720, q16ZCor], // x = 3720
        '1-2 times': [3978, q16ZCor],
        '3-4 times': [4185, q16ZCor],
        'Regularly': [4450, q16ZCor],
      };
      ...
      const modifiedPdfBytes = await pdfDoc.save();
      fs.writeFileSync(
        `step3/output/sl_${slNumberToFind}_forDtcn.pdf`,
        modifiedPdfBytes
      );
